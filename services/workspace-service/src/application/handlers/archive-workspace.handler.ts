...
import { ArchiveWorkspaceCommand } from '../commands/archive-workspace.command';
...
export class ArchiveWorkspaceHandler implements ICommandHandler<ArchiveWorkspaceCommand> {
  constructor(
  ...
  async execute(command: ArchiveWorkspaceCommand): Promise<void> {
    ...
    await this.auditRepository.log({
      ...
      reason: 'User archived workspace',
    });
